...
import { StyleSheet, View, TouchableOpacity, TextInput as RNTextInput } from 'react-native'
        ...
        {this.state.show && (
          <DatePicker
            ...
            onChange={(event, selectedDate) => {
              ...
              this.setState({ show: false, selectedDate }, () => this.props.onChange(selectedDate))
            }}
          />
        )}
